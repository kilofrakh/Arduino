...
/////////////////////////////////////////////
#include <Wire.h>
//========================================(including and defining servo's)==========
...
//=====================================(servo's controling)============================
  ...
  if (pos<50) {
    mutrs.setPWM(servo1, 0, 240);// down

  } 


  if (pos2>50) {
    mutrs.setPWM(servo2, 0, 300);//up

  } 

  if (pos2<50) {
    mutrs.setPWM(servo2, 0, 360);// down
